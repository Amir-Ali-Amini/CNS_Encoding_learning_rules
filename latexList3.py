def LatexParameters(dc):
    parameters = f"""
            ...
            $positive\_dopamine$ & ${dc["positive_dopamine"]}$ \\\\ \hline 
            $negative\_dopamine$ & ${dc["negative_dopamine"]}$ \\\\ \hline 
    ...
    """
        ...
        + """
        \end{tabular}
        \caption{Experiment Parameters related to  \\textbf{figure number } | \\textbf{part 3}}
    \end{table}
    ------------"""
    )
    print(res)
